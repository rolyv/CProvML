 ...
 * @generated
 */
public class MainMemoryItemSemanticEditPolicy extends
		CPmodeling.diagram.edit.policies.CPmodelingBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public MainMemoryItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CPmodeling.diagram.part.CPmodelingVisualIDRegistry
					.getVisualID(incomingLink) == CPmodeling.diagram.edit.parts.VirtualMachineRAMsEditPart.VISUAL_ID) {
