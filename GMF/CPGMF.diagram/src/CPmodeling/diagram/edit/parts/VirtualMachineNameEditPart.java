 ...
 * @generated
 */
public class VirtualMachineNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public VirtualMachineNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new CPmodeling.diagram.edit.policies.CPmodelingTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CPmodeling.diagram.providers.CPmodelingParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					CPmodeling.diagram.edit.parts.CPmodelingEditPartFactory
