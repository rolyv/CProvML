...
/**
 * This is the item provider adapter for a {@link CPmodeling.environment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class environmentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CPmodelingPackage.Literals.ENVIRONMENT__VMS);
			childrenFeatures.add(CPmodelingPackage.Literals.ENVIRONMENT__CP_US);
			childrenFeatures.add(CPmodelingPackage.Literals.ENVIRONMENT__RA_MS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CPmodelingPackage.Literals.ENVIRONMENT__VMS,
				 CPmodelingFactory.eINSTANCE.createvirtualMachine()));

		newChildDescriptors.add
			(createChildParameter
				(CPmodelingPackage.Literals.ENVIRONMENT__CP_US,
				 CPmodelingFactory.eINSTANCE.createprocessor()));

		newChildDescriptors.add
			(createChildParameter
				(CPmodelingPackage.Literals.ENVIRONMENT__RA_MS,
				 CPmodelingFactory.eINSTANCE.createmainMemory()));
	}
