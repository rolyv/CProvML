...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menu) {

		{
			IMenuManager menuX = new MenuManager(
					cloudProvisioning.diagram.part.Messages.ApplicationMenuName_File,
...

			{
				IMenuManager menuXX = new MenuManager(
						cloudProvisioning.diagram.part.Messages.ApplicationMenuName_New,
						"new");
		...
		{
			IMenuManager menuX = new MenuManager(
					cloudProvisioning.diagram.part.Messages.ApplicationMenuName_Edit,
		...
		{
			IMenuManager menuX = new MenuManager(
					cloudProvisioning.diagram.part.Messages.ApplicationMenuName_Window,
		...
		{
			IMenuManager menuX = new MenuManager(
					cloudProvisioning.diagram.part.Messages.ApplicationMenuName_Help,
		...
		if (editorDescriptor == null) {
			MessageDialog
					.openError(
							...
							cloudProvisioning.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorTitle,
							NLS.bind(
									cloudProvisioning.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorMessage,
			...
			try {
				...
				MessageDialog
						.openError(
								workbenchWindow.getShell(),
								cloudProvisioning.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultEditorOpenErrorTitle,
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			cloudProvisioning.diagram.part.CpgCreationWizard wizard = new cloudProvisioning.diagram.part.CpgCreationWizard();
	...
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MessageDialog
					.openInformation(
							getWindow().getShell(),
							cloudProvisioning.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogTitle,
							cloudProvisioning.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogMessage);
		}
	}
