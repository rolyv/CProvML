...
public class WizardNewFileCreationPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		label.setText(cloudProvisioning.diagram.part.Messages.WizardNewFileCreationPage_FileLabel);
		...
		button.setText(cloudProvisioning.diagram.part.Messages.WizardNewFileCreationPage_BrowseButton);
		...
		button.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				dialog.setText(cloudProvisioning.diagram.part.Messages.WizardNewFileCreationPage_SelectNewFileDialog);
	...
	protected boolean validatePage() {
		String fileName = fileNameEditor.getText().trim();
		if (fileName.length() == 0) {
			setErrorMessage(cloudProvisioning.diagram.part.Messages.WizardNewFileCreationPage_EmptyFileNameError);
			return false;
		}
		if (!new Path("").isValidPath(fileName)) { //$NON-NLS-1$
			setErrorMessage(cloudProvisioning.diagram.part.Messages.WizardNewFileCreationPage_InvalidFileNameError);
			return false;
		}
