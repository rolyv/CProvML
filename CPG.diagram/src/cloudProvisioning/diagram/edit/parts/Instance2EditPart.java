...
public class Instance2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new cloudProvisioning.diagram.edit.policies.Instance2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof cloudProvisioning.diagram.edit.parts.InstanceName2EditPart) {
			((cloudProvisioning.diagram.edit.parts.InstanceName2EditPart) childEditPart)
