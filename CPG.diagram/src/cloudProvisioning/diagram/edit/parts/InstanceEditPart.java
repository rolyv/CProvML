...
public class InstanceEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new cloudProvisioning.diagram.edit.policies.InstanceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof cloudProvisioning.diagram.edit.parts.InstanceNameEditPart) {
			((cloudProvisioning.diagram.edit.parts.InstanceNameEditPart) childEditPart)
