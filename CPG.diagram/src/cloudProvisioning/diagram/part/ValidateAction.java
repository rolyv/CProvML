...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(cloudProvisioning.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (cloudProvisioning.diagram.part.CpgDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		cloudProvisioning.diagram.providers.CpgValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		View target = view;
		cloudProvisioning.diagram.part.ValidationMarker
		...
		cloudProvisioning.diagram.providers.CpgValidationDecoratorProvider
	...
	private static void createMarkers(View target, IStatus validationStatus,
		...
		cloudProvisioning.diagram.part.CpgDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new cloudProvisioning.diagram.part.CpgDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = cloudProvisioning.diagram.part.CpgDiagramEditorUtil
	...
	private static void addMarker(EditPartViewer viewer, View target,
		...
		new cloudProvisioning.diagram.part.ValidationMarker(location, message,
