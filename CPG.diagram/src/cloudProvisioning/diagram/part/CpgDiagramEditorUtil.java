 ...
 * @generated
 */
public class CpgDiagramEditorUtil {
	...
	public static boolean openDiagram(Resource diagram)
		...
		page.openEditor(new URIEditorInput(diagram.getURI()),
				cloudProvisioning.diagram.part.CpgDiagramEditor.ID);
		return true;
	}
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							cloudProvisioning.diagram.part.Messages.CpgDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									cloudProvisioning.diagram.part.Messages.CpgDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = cloudProvisioning.diagram.part.CpgDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						cloudProvisioning.diagram.part.Messages.CpgDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				cloudProvisioning.diagram.part.Messages.CpgDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				cloudProvisioning.Canvas model = createInitialModel();
	 ...
	 * @generated
	 */
	private static cloudProvisioning.Canvas createInitialModel() {
		return cloudProvisioning.CloudProvisioningFactory.eINSTANCE
				.createCanvas();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(cloudProvisioning.Canvas model,
			Resource resource) {
