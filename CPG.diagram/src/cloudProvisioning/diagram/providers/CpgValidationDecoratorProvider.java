 ...
 * @generated
 */
public class CpgValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof cloudProvisioning.diagram.part.CpgDiagramEditor) {
	...
	public static class StatusDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			cloudProvisioning.diagram.part.ValidationMarker foundMarker = null;
			cloudProvisioning.diagram.part.ValidationMarker[] markers = cloudProvisioning.diagram.part.ValidationMarker
			...
			for (int i = 0; i < markers.length; i++) {
				cloudProvisioning.diagram.part.ValidationMarker marker = markers[i];
