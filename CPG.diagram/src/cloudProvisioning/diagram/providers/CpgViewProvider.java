 ...
 * @generated
 */
public class CpgViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return cloudProvisioning.diagram.edit.parts.CanvasEditPart.MODEL_ID
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!cloudProvisioning.diagram.edit.parts.CanvasEditPart.MODEL_ID
						.equals(cloudProvisioning.diagram.part.CpgVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(cloudProvisioning.diagram.edit.parts.CanvasEditPart.MODEL_ID);
	 ...
	 * @generated
	 */
	public Node createEnvironment_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(cloudProvisioning.diagram.part.CpgVisualIDRegistry
				.getType(cloudProvisioning.diagram.edit.parts.EnvironmentEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(
				node,
				cloudProvisioning.diagram.part.CpgVisualIDRegistry
						.getType(cloudProvisioning.diagram.edit.parts.EnvironmentEnvironmentCompartmentEditPart.VISUAL_ID),
	 ...
	 * @generated
	 */
	public Node createInstance_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(cloudProvisioning.diagram.part.CpgVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!cloudProvisioning.diagram.edit.parts.CanvasEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", cloudProvisioning.diagram.edit.parts.CanvasEditPart.MODEL_ID); //$NON-NLS-1$
