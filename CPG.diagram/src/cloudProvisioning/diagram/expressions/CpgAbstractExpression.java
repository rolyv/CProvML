 ...
 * @generated
 */
public abstract class CpgAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = cloudProvisioning.diagram.part.CpgDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected CpgAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
