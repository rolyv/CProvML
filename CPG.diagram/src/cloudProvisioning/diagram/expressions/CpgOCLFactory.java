package cloudProvisioning.diagram.expressions;
 ...
 * @generated
 */
public class CpgOCLFactory {

	/**
	 * @generated
	 */
	private final cloudProvisioning.diagram.expressions.CpgAbstractExpression[] expressions;
	 ...
	 * @generated
	 */
	private static CpgOCLFactory getInstance() {
		CpgOCLFactory instance = cloudProvisioning.diagram.part.CpgDiagramEditorPlugin
				.getInstance().getCpgOCLFactory();
		if (instance == null) {
			cloudProvisioning.diagram.part.CpgDiagramEditorPlugin.getInstance()
					.setCpgOCLFactory(instance = new CpgOCLFactory());
		}
		return instance;
	}
	 ...
	 * @generated
	 */
	public static cloudProvisioning.diagram.expressions.CpgAbstractExpression getExpression(
			int index, EClassifier context, Map<String, EClassifier> environment) {
		CpgOCLFactory cached = getInstance();
	...
	private static class Expression extends
			cloudProvisioning.diagram.expressions.CpgAbstractExpression {
