...
/**
 * This is the item provider adapter for a {@link cloudProvisioning.Canvas} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CanvasItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CloudProvisioningPackage.Literals.CANVAS__ENVIRONMENTS);
			childrenFeatures.add(CloudProvisioningPackage.Literals.CANVAS__INSTANCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CloudProvisioningPackage.Literals.CANVAS__ENVIRONMENTS,
				 CloudProvisioningFactory.eINSTANCE.createEnvironment()));

		newChildDescriptors.add
			(createChildParameter
				(CloudProvisioningPackage.Literals.CANVAS__INSTANCES,
				 CloudProvisioningFactory.eINSTANCE.createInstance()));
	}
